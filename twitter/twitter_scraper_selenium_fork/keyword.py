...
def scrape_keyword(keyword: str, browser: str = "firefox", until: Union[str, None] = None,
                   since: Union[str, None] = None, since_id: Union[int, None] = None, max_id: Union[int, None] = None,
    ...
    Args:
        ...
        query_parameters (dict, optional): extra parameters to pass to the query in the format name: value in a dictionary
